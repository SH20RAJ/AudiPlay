...
function createcontainer() {
    var ap_con = document.createElement("div");
    ap_con.innerHTML = ap_html;
    document.body.appendChild(ap_con);
  }
...
setTimeout(function () {o('.ap_time').innerHTML = '  '+secondsToMinutes(ap_audio.duration)}, 100)
